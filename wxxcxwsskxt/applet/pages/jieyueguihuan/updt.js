// pages/jieyueguihuan/add.js

const app = getApp();
const DB = require("../../request/db");
const store = require("../../request/module/jieyueguihuan");
...
Page({
    ...
    checkForm(form) {
        return new Promise((resolve, reject) => {
            ...
            rules.shijiguihuanshijian = [{ required: true, message: "请填写实际归还时间" }];
        ...
        return new Promise((resolve, reject) => {
            ...
            store
                ...
                .then((res) => {
                    ...
                    if (this.data.form.shijiguihuanshijian) {
                        this.setData({
                            currentshijiguihuanshijian: new Date(this.data.form.shijiguihuanshijian).getTime(),
                        });
                    }
    ...
    onCloseshijiguihuanshijian() {
        this.setData({
            showshijiguihuanshijian: false,
        });
    },
    onShowshijiguihuanshijian() {
        this.setData({
            showshijiguihuanshijian: true,
        });
    },
});
