// pages/tousujianyi/add.js

const app = getApp();
const DB = require("../../request/db");
const store = require("../../request/module/tousujianyi");
...
Page({
    ...
    async onLoad(options) {
        ...
        this.setData({ "form.fankuiyonghu": app.session("username") });
    },
    ...
    checkForm(form) {
        return new Promise((resolve, reject) => {
            ...
            rules.lianxidianhua = [{ required: true, message: "请填写联系电话" }];

            rules.fankuileixing = [{ required: true, message: "请填写反馈类型" }];

            rules.fankuineirong = [{ required: true, message: "请填写反馈内容" }];
