...
@Service
public class TushubaosunService {

    @Resource
    private TushubaosunMapper mapper;

    /**
     *   根据id获取一行数据
     * @param id 主键id
     */
    public ResponseData<Tushubaosun> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Tushubaosun>> selectAll(Wrapper<Tushubaosun> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Tushubaosun>> selectAll() {
        QueryWrapper<Tushubaosun> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Tushubaosun> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Tushubaosun> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Tushubaosun> wrapper = Wrappers.query();
        ...
        if (!StringUtil.isNullOrEmpty(map.get("baosunbianhao"))) {
            wrapper.like("baosunbianhao", map.get("baosunbianhao"));
        }
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Tushubaosun>> filter(Map<String, Object> map) {
        Class<Tushubaosun> aClass = Tushubaosun.class;
        com.jntoo.db.QueryWrapper<Tushubaosun> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Tushubaosun> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Tushubaosun entityData, Map post) {
        ...
        if (entityData.getId() != null) {
            ...
            DB.execute("UPDATE tushuxinxi SET tushukucun = tushukucun-'" + post.get("baosunshuliang") + "' WHERE id='" + post.get("tushuxinxiid") + "'");
    ...
    public ResponseData<Object> update(Tushubaosun entityData, Map post) {
