...
@Service
public class TushujieyueService {

    @Resource
    private TushujieyueMapper mapper;

    /**
     *   根据id获取一行数据
     * @param id 主键id
     */
    public ResponseData<Tushujieyue> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Tushujieyue>> selectAll(Wrapper<Tushujieyue> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Tushujieyue>> selectAll() {
        QueryWrapper<Tushujieyue> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Tushujieyue> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Tushujieyue> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Tushujieyue> wrapper = Wrappers.query();
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Tushujieyue>> filter(Map<String, Object> map) {
        Class<Tushujieyue> aClass = Tushujieyue.class;
        com.jntoo.db.QueryWrapper<Tushujieyue> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Tushujieyue> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Tushujieyue entityData, Map post) {
        ...
        if (entityData.getId() != null) {
            ...
            DB.execute("UPDATE tushuxinxi SET tushukucun = tushukucun-1, jieyuecishu = jieyuecishu+1 WHERE id='" + post.get("tushuxinxiid") + "'");
    ...
    public ResponseData<Object> update(Tushujieyue entityData, Map post) {
