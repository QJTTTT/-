<template>
    <div class="views-tushubaosun-add">
        <div>
...
<script setup>
    ...
    import { useTushubaosunCreateForm, canTushubaosunInsert } from "@/module";
    ...
    const { form, readMap } = useTushubaosunCreateForm(props.id);
        ...
        return new Promise((resolve, reject) => {
            formModel.value
                ...
                .then((res) => {
                    ...
                    loading.value = true;
                    canTushubaosunInsert(form).then(
                        (res) => {
                            loading.value = false;
                            if (res.code == 0) {
