<template>
    <div class="views-tushuxujie-updt">
        <div>
...
<script setup>
    ...
    import { useTushuxujieFindById, canTushuxujieFindById, canTushuxujieUpdate, canTushujieyueFindById } from "@/module";
    ...
    const form = useTushuxujieFindById(props.id);
