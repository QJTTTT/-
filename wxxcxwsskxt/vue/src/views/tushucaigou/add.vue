<template>
    <div class="views-tushucaigou-add">
        <div>
...
<script setup>
    ...
    import { useTushucaigouCreateForm, canTushucaigouInsert } from "@/module";
    ...
    const { form, readMap } = useTushucaigouCreateForm(props.id);
        ...
        return new Promise((resolve, reject) => {
            formModel.value
                ...
                .then((res) => {
                    ...
                    loading.value = true;
                    canTushucaigouInsert(form).then(
                        (res) => {
                            loading.value = false;
                            if (res.code == 0) {
