        ...
        <div>
            <el-card class="box-card">
                ...
                <el-table border :data="lists" style="width: 100%" @sort-change="sortChange" highlight-current-row>
                    ...
                    <el-table-column prop="caigoubeizhu" label="采购备注"width="180">
                    ...
                    <el-table-column prop="addtime" label="采购时间"width="180">
...
<script setup>
    ...
    const loadList = (page) => {
        ...
        http.post("/api/tushucaigou/selectPages", search).then(
            (res) => {
                loading.value = false;
                if (res.code == 0) {
                    var data = res.data;
