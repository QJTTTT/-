<template>
    <div class="views-tushujieyue-add">
        <div>
...
<script setup>
    ...
    import { useTushujieyueCreateForm, canTushujieyueInsert } from "@/module";
    ...
    const { form, readMap } = useTushujieyueCreateForm(props.id);
        ...
        return new Promise((resolve, reject) => {
            formModel.value
                ...
                .then((res) => {
                    ...
                    loading.value = true;
                    canTushujieyueInsert(form).then(
                        (res) => {
                            loading.value = false;
                            if (res.code == 0) {
