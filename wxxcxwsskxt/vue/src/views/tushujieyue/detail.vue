<template>
    <div class="views-tushujieyue-detail">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 图书借阅详情 </span>
                    </div>
                </template>
                ...
                <div id="printdetail">
                    <el-descriptions class="margin-top" :column="3" border>
                        ...
                        <el-descriptions-item label="借阅状态"> {{ map.jieyuezhuangtai }} </el-descriptions-item>
                    </el-descriptions>
...
<script setup>
    ...
    import { useTushujieyueFindById, canTushujieyueFindById } from "@/module";
     ...
     * @type {ETushujieyue}
     */
    const map = useTushujieyueFindById(props.id);
    watch(
        () => props.id,
        (id) => {
