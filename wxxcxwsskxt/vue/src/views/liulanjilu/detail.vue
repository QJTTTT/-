<template>
    <div class="views-liulanjilu-detail">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 浏览记录详情 </span>
                    </div>
                </template>
                ...
                <div id="printdetail">
                    <el-descriptions class="margin-top" :column="3" border>
                        ...
                        <el-descriptions-item label="浏览用户"> {{ map.liulanyonghu }} </el-descriptions-item>
                        <el-descriptions-item label="浏览时间"> {{ map.addtime }} </el-descriptions-item>
                    </el-descriptions>
...
<script setup>
    ...
    import { useLiulanjiluFindById, canLiulanjiluFindById } from "@/module";
     ...
     * @type {ELiulanjilu}
     */
    const map = useLiulanjiluFindById(props.id);
    watch(
        () => props.id,
        (id) => {
