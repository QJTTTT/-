<template>
    <div class="views-jieyueguihuan-updt">
        <div>
            <el-card class="box-card">
                ...
                <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                    ...
                    <el-form-item label="是否准时 " prop="shifouzhunshi">
                        <el-select v-model="form.shifouzhunshi"
                            ><el-option label="准时" value="准时"></el-option>
...
<script setup>
    ...
    import { useJieyueguihuanFindById, canJieyueguihuanFindById, canJieyueguihuanUpdate, canTushujieyueFindById } from "@/module";
    ...
    const form = useJieyueguihuanFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canJieyueguihuanUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
