<template>
    <div class="views-tushuxinxi-add">
        <div>
...
<script setup>
    ...
    import { useTushuxinxiCreateForm, canTushuxinxiInsert } from "@/module";
    ...
    const { form } = useTushuxinxiCreateForm();
